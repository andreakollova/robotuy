    ...
    <div style={{ minHeight: '100vh', background: '#000', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px 20px' }}>
      <div style={{ maxWidth: 440, width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24 }}>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.45 }}
          style={{ padding: '14px 18px', background: '#010d33', border: '1px solid #1a1a1a', borderRadius: 16, width: '100%' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 }}
          ...
          {[
            ...
            <div key={label} style={{ padding: '14px 16px', background: '#010d33', border: '1px solid #1a1a1a', borderRadius: 14, display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              {!itemRevealed ? (
                <motion.button
                  ...
                  style={{
                    ...
                    background: '#010d33', border: '1.5px solid #2a2a2a',
