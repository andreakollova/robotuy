...
const s = { bg: '#041540', card: '#0c255a', border: '#0c255a', blue: '#22c55e', text: '#fff', dim: '#666' };
...
export default function TodoPreview({ variables }: { variables: Record<string, any> }) {
  ...
  return (
    <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {isEmpty && (
        <div style={{
          padding: 32, textAlign: 'center', color: '#0f2d6b', fontSize: 13, lineHeight: 1.6,
        }}>
            ...
            return (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  border: `2px solid ${completed ? s.blue : '#0f2d6b'}`,
                  transition: 'all 0.2s',
                }}>
                ...
                {/* Delete button */}
                {hasRemoveFn && (
                  <span style={{ color: '#0f2d6b', fontSize: 14, cursor: 'default' }}>×</span>
                )}
              </div>
            );
          })}
