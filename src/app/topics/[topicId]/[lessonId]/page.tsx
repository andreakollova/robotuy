        ...
        {tab === 'lesson' && lesson.content && (
          <div className="lesson-content" style={{ color: 'var(--text-secondary)', fontSize: 14.5, lineHeight: 1.75, marginBottom: 32, background: '#fff', borderRadius: 16, padding: '24px 28px', border: '1px solid var(--border)' }}>
            {(() => {
              ...
              if (trimmed === ':::') { inRecap = false; return <div key={i} style={{ padding: '0 16px 8px', background: 'rgba(34,197,94,0.04)', borderLeft: '1px solid rgba(34,197,94,0.1)', borderRight: '1px solid rgba(34,197,94,0.1)', borderBottom: '2px solid rgba(34,197,94,0.25)', borderRadius: '0 0 12px 12px', marginBottom: 10 }} />; }
