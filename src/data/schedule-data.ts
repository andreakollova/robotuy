...
export const scheduleMonths: Month[] = [
  // MONTH 1
  {
    ...
    subtitleSK: 'Teoria obvodov, Kirchhoff, op-ampy',
    activeCourses: ['MR', 'EL'],
    weeks: [
      {
        ...
        labSK: 'Zaklady breadboardu. Postav LED + resistor obvod. Multimetrom zmeraj napatie a prud.',
      },
      {
        ...
        labSK: 'Potenciometer voltage divider. Nastavitelne napatie merane multimetrom.',
      },
      {
        ...
        labSK: 'Svetelny senzor. LDR + resistor voltage divider. Sleduj zmenu napatia podla svetla.',
      },
      {
        ...
        labSK: 'Experimenty s diodami. LED polarita + diodova ochrana.',
      },
    ],
  ...
  // MONTH 2
  {
    ...
    titleSK: 'Elektronika II + Prvy Hardware',
    subtitle: 'Rectifiers, MOSFET, BJT, Arduino',
    subtitleSK: 'Usmernovace, MOSFET, BJT, Arduino',
    activeCourses: ['MR', 'EL'],
    weeks: [
      { weekNum: 5, focus: 'Diodes/Rectifiers', focusSK: 'Diody/Usmernovace', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'EL', label: 'Electronics', labelSK: 'Elektronika' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'EL', label: 'Electronics', labelSK: 'Elektronika' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Robotics Lab', labelSK: 'Robotics Lab' },
      ], lab: 'Rectifier simulation in LTspice.', labSK: 'Simulacia usmernovaca v LTspice.' },
      { weekNum: 6, focus: 'Voltage regulators / MOSFET', focusSK: 'Regulatory napatia / MOSFET', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'EL', label: 'Electronics', labelSK: 'Elektronika' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'EL', label: 'Electronics', labelSK: 'Elektronika' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Robotics Lab', labelSK: 'Robotics Lab' },
      ], lab: 'MOSFET as switch. Low-voltage DC load.', labSK: 'MOSFET ako spinac. Nizkonapatiova DC zataz.' },
      { weekNum: 7, focus: 'MOSFET continued', focusSK: 'MOSFET pokracovanie', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'EL', label: 'Electronics', labelSK: 'Elektronika' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'EL', label: 'Electronics', labelSK: 'Elektronika' },
      ...
      { weekNum: 8, focus: 'BJT + Course finish', focusSK: 'BJT + Dokoncenie kurzu', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'EL', label: 'Electronics', labelSK: 'Elektronika' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'EL', label: 'Electronics', labelSK: 'Elektronika' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Robotics Lab', labelSK: 'Robotics Lab' },
      ], project: 'PROJECT #1 - Automatic light. LDR -> Arduino -> threshold -> LED.', projectSK: 'PROJEKT #1 - Automaticke svetlo. LDR -> Arduino -> threshold -> LED.' },
    ],
    milestone: 'Electronics course complete.',
    milestoneSK: 'Kurz elektroniky dokonceny.',
  },
  // MONTH 3
  {
    month: 3, title: 'IoT + Arduino', titleSK: 'IoT + Arduino',
    subtitle: 'Embedded systems, IoT architecture, Arduino C', subtitleSK: 'Embedded systemy, IoT architektura, Arduino C',
    activeCourses: ['MR', 'IOT'],
    weeks: [
      { weekNum: 9, focus: 'IoT Course 1: embedded / IoT architecture', focusSK: 'IoT Kurz 1: embedded / IoT architektura', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
      ...
      ], lab: 'Arduino digital I/O. Button -> Arduino -> LED.', labSK: 'Arduino digitalny I/O. Tlacidlo -> Arduino -> LED.' },
      { weekNum: 10, focus: 'IoT Course 1 continued', focusSK: 'IoT Kurz 1 pokracovanie', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
      ...
      { weekNum: 11, focus: 'IoT Course 2: Arduino + C', focusSK: 'IoT Kurz 2: Arduino + C', days: [
        ...
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Arduino Lab', labelSK: 'Arduino Lab' },
      ], lab: 'PWM LED dimmer. Potentiometer -> ADC -> Arduino -> PWM -> LED.', labSK: 'PWM LED stmievac. Potenciometer -> ADC -> Arduino -> PWM -> LED.' },
      { weekNum: 12, focus: 'Arduino + C continued', focusSK: 'Arduino + C pokracovanie', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Arduino Lab', labelSK: 'Arduino Lab' },
      ], project: 'PROJECT #2 - Servo distance scanner. Servo + ultrasonic sensor, scan 0-180 degrees.', projectSK: 'PROJEKT #2 - Servo distance scanner. Servo + ultrazvukovy senzor, scan 0-180 stupnov.' },
    ],
    milestone: 'First mechatronics project complete.',
    milestoneSK: 'Prvy mechatronicky projekt hotovy.',
  },
  // MONTH 4
  {
    month: 4, title: 'IoT + Fusion 360', titleSK: 'IoT + Fusion 360',
    subtitle: 'Mechanical design, 3D printing, CAD', subtitleSK: 'Mechanicky dizajn, 3D tlac, CAD',
    ...
    weeks: [
      ...
      ], lab: 'Design first sensor mount.', labSK: 'Navrhni prvy sensor mount.' },
      { weekNum: 14, focus: 'Fusion: constraints + drawings', focusSK: 'Fusion: constraints + vykresy', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'CAD', label: 'Fusion 360', labelSK: 'Fusion 360' },
      ...
      { weekNum: 15, focus: 'Fusion: 3D printing + tolerances', focusSK: 'Fusion: 3D tlac + tolerancie', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'CAD', label: 'Fusion 360', labelSK: 'Fusion 360' },
      ...
      { weekNum: 16, focus: 'Fusion: parametric modeling', focusSK: 'Fusion: parametricke modelovanie', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'CAD', label: 'Fusion 360', labelSK: 'Fusion 360' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Project Lab', labelSK: 'Projektovy Lab' },
  ...
  // MONTH 5
  {
    ...
    subtitle: 'Variables, control flow, functions, arrays', subtitleSK: 'Premenne, riadenie toku, funkcie, polia',
    activeCourses: ['MR', 'IOT', 'CPP'],
    weeks: [
      { weekNum: 17, focus: 'C: variables, types, operators', focusSK: 'C: premenne, typy, operatory', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'CPP', label: 'C/C++', labelSK: 'C/C++' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Programming Lab', labelSK: 'Programovaci Lab' },
      ], lab: 'Rewrite Arduino logic into cleaner functions.', labSK: 'Prepis Arduino logiku do cistejsich funkcii.' },
      { weekNum: 18, focus: 'C: control flow', focusSK: 'C: riadenie toku', days: [
        ...
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Programming Lab', labelSK: 'Programovaci Lab' },
      ], lab: 'Finite-state traffic light.', labSK: 'Stavovy automat semaforu.' },
      { weekNum: 19, focus: 'C: functions + arrays', focusSK: 'C: funkcie + polia', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'CPP', label: 'C/C++', labelSK: 'C/C++' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Programming Lab', labelSK: 'Programovaci Lab' },
      ], lab: 'Store last N sensor measurements, compute average.', labSK: 'Uloz poslednych N merany, vypocitaj priemer.' },
      { weekNum: 20, focus: 'C continued', focusSK: 'C pokracovanie', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'CPP', label: 'C/C++', labelSK: 'C/C++' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'MR', label: 'Modern Robotics', labelSK: 'Modern Robotics' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'IOT', label: 'IoT Course', labelSK: 'IoT Kurz' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Project Lab', labelSK: 'Projektovy Lab' },
      ], project: 'PROJECT #4 - Parking sensor. Distance -> LED blink -> buzzer.', projectSK: 'PROJEKT #4 - Parkovaci senzor. Vzdialenost -> LED blikanie -> bzuciak.' },
    ],
  },
  // MONTH 6
  {
    month: 6, title: 'C + IoT Capstone + MR Finish', titleSK: 'C + IoT Capstone + MR Finish',
    subtitle: 'Motor driver, encoder, MR completion', subtitleSK: 'Motor driver, enkoder, dokoncenie MR',
    activeCourses: ['MR', 'IOT', 'CPP'],
    weeks: [
      ...
      { weekNum: 22, focus: 'MR + C', focusSK: 'MR + C', days: [
        ...
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Motor Lab', labelSK: 'Motor Lab' },
      ], lab: 'PWM motor speed control.', labSK: 'PWM riadenie rychlosti motora.' },
      { weekNum: 23, focus: 'MR + C', focusSK: 'MR + C', days: [
        ...
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'CPP', label: 'C/C++', labelSK: 'C/C++' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Motor Lab', labelSK: 'Motor Lab' },
      ], lab: 'Encoder reading.', labSK: 'Citanie enkoderu.' },
    ...
    milestoneSK: 'Modern Robotics + IoT dokoncene.',
  },
  // MONTH 7
  {
    month: 7, title: 'C/C++ + Embedded', titleSK: 'C/C++ + Embedded',
    subtitle: 'GCC, Make, memory, modular firmware', subtitleSK: 'GCC, Make, pamat, modularny firmware',
    ...
    weeks: [
      ...
      ], lab: 'GCC compile workflow.', labSK: 'GCC kompilovaci workflow.' },
      { weekNum: 26, focus: 'GCC + Make', focusSK: 'GCC + Make', days: [
        ...
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'EMB', label: 'Embedded Systems', labelSK: 'Embedded Systemy' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Embedded Lab', labelSK: 'Embedded Lab' },
      ], lab: 'Multi-file embedded-style C project.', labSK: 'Viac-suborovy embedded C projekt.' },
      { weekNum: 27, focus: 'Memory', focusSK: 'Pamat', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'CPP', label: 'C/C++', labelSK: 'C/C++' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'EMB', label: 'Embedded Systems', labelSK: 'Embedded Systemy' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'CPP', label: 'C/C++', labelSK: 'C/C++' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'EMB', label: 'Embedded Systems', labelSK: 'Embedded Systemy' },
      ...
      { weekNum: 28, focus: 'Embedded finish', focusSK: 'Embedded dokoncenie', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'CPP', label: 'C/C++', labelSK: 'C/C++' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'EMB', label: 'Embedded Systems', labelSK: 'Embedded Systemy' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'CPP', label: 'C/C++', labelSK: 'C/C++' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'EMB', label: 'Embedded Systems', labelSK: 'Embedded Systemy' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Project Lab', labelSK: 'Projektovy Lab' },
      ], project: 'PROJECT #6 - Modular motor controller. motor.c + sensor.c + controller.c + main.c', projectSK: 'PROJEKT #6 - Modularny motor controller. motor.c + sensor.c + controller.c + main.c' },
    ],
  },
  // MONTH 8
  {
    month: 8, title: 'C++ + Power Electronics + Robot Build', titleSK: 'C++ + Vykonova Elektronika + Stavba Robota',
    subtitle: 'Buck/boost converters, robot chassis', subtitleSK: 'Buck/boost menicom, podvozok robota',
    activeCourses: ['CPP', 'PE', 'CAD'],
    weeks: [
      { weekNum: 29, focus: 'Switched converters + buck', focusSK: 'Spinavane menice + buck', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'CPP', label: 'C++', labelSK: 'C++' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'PE', label: 'Power Electronics', labelSK: 'Vykonova Elektronika' },
      ...
      { weekNum: 30, focus: 'Boost/inverting converter', focusSK: 'Boost/invertujuci menic', days: [
        ...
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'CAD', label: 'CAD/Project', labelSK: 'CAD/Projekt' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Robot Lab', labelSK: 'Robot Lab' },
      ], lab: 'Power budget for future robot.', labSK: 'Power budget pre buduceho robota.' },
      { weekNum: 31, focus: 'PE finish + Chassis design', focusSK: 'PE dokoncenie + Dizajn podvozku', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'CPP', label: 'C++', labelSK: 'C++' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'PE', label: 'Power Electronics', labelSK: 'Vykonova Elektronika' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'CPP', label: 'C++', labelSK: 'C++' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'CAD', label: 'Fusion 360', labelSK: 'Fusion 360' },
    ...
    milestoneSK: 'Prvy mobilny robot postaveny.',
  },
  // MONTH 9
  {
    month: 9, title: 'Robot Control + C++', titleSK: 'Riadenie Robota + C++',
    subtitle: 'Odometry, PID control, closed-loop', subtitleSK: 'Odometria, PID regulacia, uzavrena slucka',
    activeCourses: ['CPP'],
    weeks: [
      { weekNum: 33, focus: 'Independent motor control', focusSK: 'Nezavisle riadenie motorov', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'CPP', label: 'C++', labelSK: 'C++' },
        ...
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Robot Lab', labelSK: 'Robot Lab' },
      ], lab: 'Independent left/right motor control.', labSK: 'Nezavisle riadenie laveho/praveho motora.' },
      { weekNum: 34, focus: 'Encoders', focusSK: 'Enkodery', days: [
        ...
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'LAB', label: 'Robot Lab', labelSK: 'Robot Lab' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Robot Lab', labelSK: 'Robot Lab' },
      ], lab: 'Compute wheel RPM from encoders.', labSK: 'Vypocitaj RPM kolies z enkoderov.' },
      { weekNum: 35, focus: 'Odometry basics', focusSK: 'Zaklady odometrie', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'CPP', label: 'C++', labelSK: 'C++' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'LAB', label: 'Robot Lab', labelSK: 'Robot Lab' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'CPP', label: 'C++', labelSK: 'C++' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'LAB', label: 'Robot Lab', labelSK: 'Robot Lab' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Robot Lab', labelSK: 'Robot Lab' },
      ], lab: 'Estimate distance traveled from wheel rotations.', labSK: 'Odhadni prejdenu vzdialenost z rotacii kolies.' },
      { weekNum: 36, focus: 'PID speed control', focusSK: 'PID regulacia rychlosti', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'CPP', label: 'C++', labelSK: 'C++' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'LAB', label: 'Robot Lab', labelSK: 'Robot Lab' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'CPP', label: 'C++', labelSK: 'C++' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'LAB', label: 'Robot Lab', labelSK: 'Robot Lab' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Project Lab', labelSK: 'Projektovy Lab' },
      ], project: 'PROJECT #8 - Closed-loop mobile robot. PID speed control at 0.2 m/s.', projectSK: 'PROJEKT #8 - Uzavreta slucka mobilneho robota. PID regulacia rychlosti na 0.2 m/s.' },
    ],
  ...
  // MONTH 10
  {
    ...
    weeks: [
      ...
      { weekNum: 39, focus: 'Services + Actions + Params', focusSK: 'Servisy + Akcie + Parametre', days: [
        ...
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'LAB', label: 'ROS Lab', labelSK: 'ROS Lab' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'ROS Lab', labelSK: 'ROS Lab' },
      ], lab: 'Simulated motor-control service.', labSK: 'Simulovany motor-control servis.' },
  ...
  // MONTH 11
  {
    month: 11, title: 'Computer Vision + ROS', titleSK: 'Pocitacove Videnie + ROS',
    ...
    weeks: [
      { weekNum: 41, focus: 'CV fundamentals', focusSK: 'Zaklady CV', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'CV', label: 'Computer Vision', labelSK: 'Pocitacove Videnie' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'ROS', label: 'ROS 2', labelSK: 'ROS 2' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'CV', label: 'Computer Vision', labelSK: 'Pocitacove Videnie' },
      ...
      ], lab: 'Webcam -> OpenCV -> live video.', labSK: 'Webcam -> OpenCV -> zive video.' },
      { weekNum: 42, focus: 'Image processing', focusSK: 'Spracovanie obrazu', days: [
        ...
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'ROS', label: 'ROS 2', labelSK: 'ROS 2' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Vision Lab', labelSK: 'Vision Lab' },
      ], lab: 'Color segmentation. Detect red object.', labSK: 'Farebna segmentacia. Deteguj cerveny objekt.' },
      { weekNum: 43, focus: 'Classification/features', focusSK: 'Klasifikacia/features', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'CV', label: 'Computer Vision', labelSK: 'Pocitacove Videnie' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'ROS', label: 'ROS 2', labelSK: 'ROS 2' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'CV', label: 'Computer Vision', labelSK: 'Pocitacove Videnie' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'ROS', label: 'ROS 2', labelSK: 'ROS 2' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Vision Lab', labelSK: 'Vision Lab' },
      ], lab: 'Robot tracks colored object in image.', labSK: 'Robot sleduje farebny objekt v obraze.' },
      { weekNum: 44, focus: 'Object detection', focusSK: 'Detekcia objektov', days: [
        ...
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'ROS', label: 'ROS 2', labelSK: 'ROS 2' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Project Lab', labelSK: 'Projektovy Lab' },
      ], project: 'PROJECT #10 - Vision follower. Camera -> OpenCV -> object position -> robot turns/follows.', projectSK: 'PROJEKT #10 - Vision follower. Kamera -> OpenCV -> pozicia objektu -> robot otaca/sleduje.' },
    ],
  ...
  // MONTH 12
  {
    month: 12, title: 'Final Robotics Capstone', titleSK: 'Finalny Robotics Capstone',
    subtitle: 'Architecture, build, integration, testing, portfolio', subtitleSK: 'Architektura, stavba, integracia, testovanie, portfolio',
    activeCourses: [],
    weeks: [
      { weekNum: 45, focus: 'Architecture', focusSK: 'Architektura', days: [
      ...
      ], lab: 'Define final robot: MCU, motors, encoders, IMU, sensors, camera, ROS 2. Draw system architecture.', labSK: 'Definuj finalneho robota: MCU, motory, enkodery, IMU, senzory, kamera, ROS 2. Nakresli systemovu architekturu.' },
      { weekNum: 46, focus: 'Mechanical + Electronics', focusSK: 'Mechanika + Elektronika', days: [
        ...
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Build', labelSK: 'Stavba' },
      ], lab: 'Final chassis/mounts in Fusion. Power distribution + wiring.', labSK: 'Finalne chassis/mounty vo Fusion. Distribuca napajania + kabelaz.' },
      { weekNum: 47, focus: 'Embedded + Control', focusSK: 'Embedded + Regulacia', days: [
        ...
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'LAB', label: 'Control', labelSK: 'Regulacia' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'LAB', label: 'Control', labelSK: 'Regulacia' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Integration', labelSK: 'Integracia' },
      ], lab: 'Motor control, encoder feedback, odometry, safety states.', labSK: 'Riadenie motorov, enkoder feedback, odometria, bezpecnostne stavy.' },
      { weekNum: 48, focus: 'ROS + Perception + Autonomy', focusSK: 'ROS + Vnimanie + Autonomia', days: [
        { day: 'PO', dayEN: 'MON', hours: 3, subject: 'LAB', label: 'ROS Integration', labelSK: 'ROS Integracia' },
        { day: 'UT', dayEN: 'TUE', hours: 3, subject: 'LAB', label: 'Vision', labelSK: 'Videnie' },
        { day: 'ST', dayEN: 'WED', hours: 3, subject: 'LAB', label: 'Autonomy', labelSK: 'Autonomia' },
        { day: 'ST', dayEN: 'THU', hours: 3, subject: 'LAB', label: 'Testing', labelSK: 'Testovanie' },
        { day: 'PI', dayEN: 'FRI', hours: 3, subject: 'LAB', label: 'Portfolio', labelSK: 'Portfolio' },
      ], project: 'FINAL PROJECT - Autonomous Mobile Robot. CAD + electronics + C/C++ + ROS 2 + OpenCV + demo video.', projectSK: 'FINALNY PROJEKT - Autonomny Mobilny Robot. CAD + elektronika + C/C++ + ROS 2 + OpenCV + demo video.' },
    ],
    milestone: 'Autonomous mobile robot complete. Full portfolio ready.',
    milestoneSK: 'Autonomny mobilny robot hotovy. Kompletne portfolio pripravene.',
  },
];
